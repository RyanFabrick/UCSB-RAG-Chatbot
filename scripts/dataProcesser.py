...
class UCSBDataProcessor:
    ...
    def __init__(self, input_file: str = "data/complete_UCSB_data.json"):
        self.input_file = input_file
        self.output_file = "data/processed_documents.json"
...
if __name__ == "__main__":
    ...
    print(f"\nReady for embedding! Run: python scripts/embeddings.py")